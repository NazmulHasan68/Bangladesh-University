...
export default function NewsEventHeroSection() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
      ...
      <Slider {...settings}>
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black to-transparent flex flex-col justify-center items-center text-white text-center p-8 rounded-lg">
            <h1 className="md:text-5xl text-2xl font-extrabold drop-shadow-lg">All The Latest News and Events</h1>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black to-transparent flex flex-col justify-center items-center text-white text-center p-8 rounded-lg">
            <h1 className="md:text-5xl text-xl font-extrabold drop-shadow-lg">Another Exciting Event</h1>
            <p className="mt-4 text-sm md:text-xl font-medium drop-shadow-lg">Bangladesh University</p>
          </div>
        </div>

...
export default function LibraryHeroSection() {
  return (
    <div className="relative max-w-7xl mx-auto md:h-60 h-48 bg-slate-700/70 flex flex-col justify-center items-center md:rounded-3xl">
      ...
      <div className="relative z-10">
        <div className='text-left ml-16'>
          <h1 className="text-xs md:text-md font-medium text-yellow-300 rotate-15">Welcome to the</h1>
          <h1 className="md:text-4xl text-xl font-bold text-red-400">Bangladesh University</h1>
          <h1 className="md:text-right ml-40 italic text-sm md:text-xl text-white">Library</h1>
        </div>

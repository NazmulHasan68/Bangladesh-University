...
export default function ResearchTeaching() {
  return (
    <div className='max-w-6xl md:mx-auto mx-4 my-8 p-6 bg-slate-100 rounded-xl shadow-lg'>
      <div className='mb-8'>
        <h1 className='md:text-3xl text-xl text-sky-900 font-bold mb-4'>Teaching</h1>
        <p className='text-xs md:text-md text-sky-900 leading-relaxed'>
      ...
      <div className='flex flex-row justify-between items-center gap-2 md:gap-10 md:px-4'>
        <img 
          src='https://picsum.photos/400/300?education' 
          alt='Teaching Image 1' 
          className='md:w-48 w-32 md:flex-1 md:h-[200px] h-[120px] object-cover rounded-2xl shadow-md'
        />
        <img 

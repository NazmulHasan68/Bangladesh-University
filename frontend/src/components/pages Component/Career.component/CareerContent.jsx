...
export default function CareerContent() {
  return (
    <div className='max-w-7xl md:mx-auto mx-4 my-5 flex gap-4 md:flex-row flex-col items-center'>
      <p className='text-sky-800 italic text-sm md:text-xl md:w-[60%]'>
      ...
      <img src='https://www.insidehighered.com/sites/default/files/media/GettyImages-1161949895.jpg' className='md:w-[40%] p-5 w-full rounded-3xl h-[200px] md:h-full object-cover' />
    </div>
  )
}

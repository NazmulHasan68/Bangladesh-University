...
export default function MissionCompoent() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
    ...
    <div className="news-event-hero-section max-w-7xl mx-auto md:mt-24 mt-16">
      <Slider {...settings}>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black to-transparent flex flex-col justify-center items-center text-white text-center p-8 rounded-lg">
            <h1 className="md:text-5xl text-xl font-extrabold drop-shadow-lg">Vission of the versity</h1>
            <p className="mt-4 text-sm md:text-xl font-medium drop-shadow-lg">change the Nation</p>
          </div>
        </div>

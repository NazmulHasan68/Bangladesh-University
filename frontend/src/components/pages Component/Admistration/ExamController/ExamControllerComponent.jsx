    ...
    <div className="bg-gray-100 min-h-screen py-0 px-5 md:px-20">
      <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="mt-8 bg-white p-1 md:p-6 rounded-lg ">
          <h2 className="text-xl font-semibold text-blue-800 mb-4">Office of the Controller of Examinations</h2>
          
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white rounded-lg shadow-md">
              <thead>
                <tr className="border-b-2 bg-blue-400 border-gray-300">
                  <th className="px-6 py-3 text-left text-blue-100">Photo</th>

  ...
  return (
    <div className="bg-gray-100 min-h-screen py-0 px-2 md:px-20">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        {/* Header */}
        <h1 className="md:text-3xl text-xl font-bold text-center text-blue-700 mb-6">Message from The Treasurer</h1>
        ...
        <div className="mt-8 bg-white p-2 rounded-lg">
          <h2 className="md:text-xl text-sm font-semibold text-blue-800 mb-4">Office of the Treasurer</h2>
          <table className="min-w-full bg-white rounded-lg shadow-md overflow-x-auto">
            <thead>
              <tr className="border-b-2 bg-blue-400 border-gray-300">
                <th className="px-6 py-3 text-left md:text-sm text-xs  text-white">Image</th>
                <th className="px-6 py-3 text-left md:text-sm text-xs  text-white">Details</th>
              </tr>
            </thead>
            <tbody>
              {/* Treasurer Row */}

...
export default function TeacherApplyForm() {
    ...
    return (
        <div className="max-w-6xl mx-auto p-8 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-center mb-6">Bangladesh University Teacher Form</h2>
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
                ...
                <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-2">
                    <div className="mb-4">
                        <label htmlFor="graduation_university" className="block text-lg font-medium text-gray-700">Graduation University</label>
                        <input
                    ...
                    <div className="mb-4">
                        <label htmlFor="graduation_cgpa" className="block text-lg font-medium text-gray-700">Graduation CGPA</label>
                        <input
                            id="graduation_cgpa"
                    ...
                    <div className="mb-4">
                        <label htmlFor="post_graduation_cgpa" className="block text-lg font-medium text-gray-700">Post Graduation CGPA</label>
                        <input
                            id="post_graduation_cgpa"
                            name="post_graduation_cgpa"
                            type="number"
                    ...
                    <div className="mb-4">
                        <label htmlFor="post_graduation_university" className="block text-lg font-medium text-gray-700">Post Graduation University</label>
                        <input
                    ...
                    <div className='mb-4'>
                        <label htmlFor="roll" className="block text-lg font-medium text-gray-700">Join as a</label>
                            ...
                            >
                                ...
                                <option value="junior_professor">Junior Professor</option>
